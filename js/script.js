...
var Tracking = /*#__PURE__*/function () {
  ...
  _proto10.onLoad = /*#__PURE__*/function () {
    var _onLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
      var storage, scanner, platformsFilter, clientService, _document3, _URL2, _session$lastHistory, baseURL, sessionService, sessionHistoryService, parser, productData, sessionId, clientHash, clientId, _session, producer, _history$lastHistory, lastHistory, _queryParams, history, _queryParams2, session, queryParams, _error$response;
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 54:
            ...
            Logger.error("" + ((_context13.t0 == null || (_error$response = _context13.t0.response) == null || (_error$response = _error$response.data) == null ? void 0 : _error$response.message) || _context13.t0));
          case 58:
          case "end":
